...
const rows = [
    { sr: "1", tamplate: "Dear Customer, Make sure you don't compromise on the future of your loved ones. Renew your  Aditya Birla Sun Life Insurance policy today by paying your premium of Rs. {#var#} on your policy {#var#} which is due on {#var#}. Click to pay now or locate branch Click https://bit.ly/2UIeKVG. Ignore if already paid. T&C Apply. - ABSLI.", category: "ICCSII", EntityID: "11122********1233", Status: "Approved", Action: "" },
    { sr: "3", tamplate: "Dear {#var#}, Renew your policy on time and stay protected. Click now to pay online or locate branch https://bit.ly/2UIeKVG. Ignore if already paid. T&C Apply. - ABSLI.", category: "ICCSII", EntityID: "11122********1233", Status: "Approved", Action: "" },
    { sr: "4", tamplate: "Dear Customer, Avoid losing out on reviving your lapsed policy and losing accumulated policy benefits. Pay due premium of {#var#} to revive your policy no. {#var#} and continue to protect your family's financial future. Click here to pay now or locate branch  https://bit.ly/2UIeKVG  Ignore if already paid. T&C Apply. - ABSLI.", category: "ICCSII", EntityID: "11122********1233", Status: "Approved", Action: "" },
];
...
export default function CreateTemplate() {
    ...
    let columns = [
        {
            field: "sr", headerName: "Sr.", minWidth: 50, flex: 1
        },
        {
            field: "tamplate", headerName: "Templete", minWidth: 200, flex: 1,
            headerClassName: "table-header", renderCell: (params) =>
                params.value && <Tooltip title={<Function title={params.value} />} color="inherit" placement="bottom-start">
                    <span><Function title={params.value} /></span>
                </Tooltip>
        },

        {
            ...
            renderCell: (params) =>
                params.value && (
                    <Function title={params.value} org="Organization" />
                )
        },
        {
            field: "EntityID", headerName: "PEID", minWidth: 150, flex: 1,
            renderCell: (params) =>
                params.value && (
                    <Function title={params.value} org="Organization" />
                )
            ...
            <Grid container spacing={2} style={{ marginTop: 1 }}>
                <form onSubmit={handleFileUpload}>
                    <Grid container>
                        ...
                        <Grid item xs={12} md={3} style={{ paddingTop: 8 }}>
