        ...
        data: [
            {
                ...
                validation: Yup.string().required("Phone number required").matches(/^[0-9]{10}$/, 'Invalid mobile number'),
                type: "text",
                fullWidth: true,
            ...
            <Grid container spacing={2} mt={2}>
                ...
                <Grid item xs={12} md={12} lg={6}>
                    <SoftBox mt={1}>
                        <SoftBox mb={3}>
                            <Card style={{ padding: "10px" }}>
                                <Grid container justifyContent="space-between" alignItems="center" px={2} pt={1}>
                                    <Grid item>
