...
export default function ManageParameter() {
    ...
    useEffect(() => {
        (async () => {
            try {
                await DynamicApiCall(`multimedia/getparameterall/PARA_CODE/PARA_PROP`, 'get', token).then((res) => {
    ...
    async function getParameter(paraprop) {
        const Info = await DynamicApiCall(`multimedia/getParamdata/ALL/${paraprop}/mmadmin`, "get", token);
                    ...
                    <Card>
                        <SoftBox >
                            <SoftBox mb={3}>
                                ...
                                <SoftBox>
                                    <CustomTable rows={rowData} columns={columns} uniquekey="paracode" />
                                </SoftBox>
                            </SoftBox>
